...
// Data class menyediakan fungsi untuk meng-ovveride fungsi equaks(), hashCode(), dan toString().
// Data class juga menyediakan funsgi copy() untuk membuat salinan objek dengan beberapa perubahan.
